    ...
    return (
        <div className='w-[100%] h-[700px]'>
            <div className='rounded-[10px] w-[100%] border overflow-y-auto'>
                <div className='w-[100%] h-[75px] flex items-center justify-between p-[20px] border-b'>
                    <h1 className='text-[25px] font-bold '>User Details</h1>
                    <button onClick={() => { navigat("/signup") }} className='sidebtn2'>Add Users</button>
                </div>
                <div className='p-[20px] w-[1500px] 2xl:w-[100%] '>
                    <div className='bg-[lightgrey] w-[100%] h-[80px] border justify-between p-[20px] flex'>
                        ...
                        {/* <div className='w-[15%] h-[100%] flex items-center justify-center'>
                            <h1 className='text-[18px] font-medium'>Product Prise</h1>
                        </div> */}
                        <div className='w-[10%] h-[100%] flex items-center justify-center'>
                    ...
                    <div id='derr' className='scroll-smooth   overflow-auto  h-[500px] ' >
                        {dataa.isLoding ? <><Skeleton /><Skeleton /><Skeleton /></> :
                            dataa.user.map((el) => {
                                return <div key={el.id} className='w-[100%] h-[80px] border-b border-e border-s justify-between p-[20px] flex'>
                                    <div className='w-[10%] h-[100%] flex items-center justify-center'>
                                    ...
                                    <div className='w-[12%] h-[100%] flex items-center justify-center cursor-pointer' id='view'>
                                        <h1 onClick={() => openModal(el.id)} className='text-[18px] text-[blue]  font-medium underline underline-offset-8'>View More</h1>
                                    </div>
                                </div>
                            })
                        }
